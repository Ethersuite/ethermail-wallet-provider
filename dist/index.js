...
__export(src_exports, {
  EtherMailProvider: () => EtherMailProvider
});
...
var getPublicClient = (chainId, rpcUrl) => {
  let chain = import_chains.mainnet;
  if (chainId === 137) {
...
var BaseCommunicator = class {
  constructor(strategy, options) {
    ...
    this.deviceId = (0, import_uuid.v4)();
  }
  disconnect() {
    ...
    const messageHandler = (event) => {
      ...
      if (origin === this.appUrl) {
        if (data && data.type === "iframeSign") {
          return;
        } else if (config.requestId && ((_a = data.request) == null ? void 0 : _a.id) !== config.requestId) {
          return;
...
var SocketCommunicator = class extends BaseCommunicator {
  ...
  createSocket(token) {
    this.socket = (0, import_socket.default)(this.websocketServer, {
...
var EtherMailProvider = class {
  ...
  disconnect() {
    return __async(this, null, function* () {
      ...
      const error = new import_viem2.ProviderRpcError(
      ...
      switch (method) {
        ...
        case "eth_sign": {
          return (_e = this._communicator) == null ? void 0 : _e.emitExternalEvent({
            ...
            data: (0, import_viem2.hexToString)(params[1]),
            chainId: this.chainId
          });
        }
        case "personal_sign":
        ...
        case "eth_signTransaction":
          const dataToSign = (0, import_viem2.hexToString)(params[0]);
